...
Donate link: https://wirenomads.com
...
Countdown Timer is a 100% free and customizable plugin, which allows you to create countless countdown models that suit the style of your website.
...
= Does the plugin uses my local time to calculate the remaining time? =

NO, it uses your wordpress installation time (which could be the sames as your local time).

= Is there is unavailable options that I can't access unless I pay? =

NO, the plugin is 100% free, have fun with it ;)

= Can I hide the "years" and "months" label from the timer =

Yes, I have include more than 120 parameters and options, so you will be able to customize almost everything

== Screenshots ==

1. Set Goal Date and Time (Settings)
2. Labels (Settings)
3. Text Options (Settings)
4. Load/Save Timers (Settings)
5. Timer1 (Frontend)
6. Timer2 (Frontend)
7. Timer3 (Frontend)
8. Timer4 (Frontend)
